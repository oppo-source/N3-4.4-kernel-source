...
#define AUTO_CHARGING_BATT_TEMP_T2                            150//sjc1125//50  
#define AUTO_CHARGING_BATT_TEMP_T3                            480//sjc1125//450  
...
qpnp_chg_set_appropriate_vddmax(struct qpnp_chg_chip *chip)
{
	if(chip->mBatteryTempRegion == CV_BATTERY_TEMP_REGION_LITTLE__COLD)
		...
		qpnp_chg_vddmax_set(chip, chip->max_voltage_mv);//sjc1125//qpnp_chg_vddmax_set(chip,chip->cool_bat_mv);
...
/* jingchun.wang@Onlinerd.Driver, 2013/12/18  Add for solve mistake end of charging, add 100mv confirm */
		if(qpnp_battery_temp_region_get(chip) == CV_BATTERY_TEMP_REGION_LITTLE__COLD) {
			...
			max_comp_volt = chip->max_voltage_mv - 50;//sjc1125//max_comp_volt = chip->cool_bat_mv - 50;
...
/* OPPO 2013-11-05 wangjc Add end */
		...
		qpnp_chg_vbatdet_set(chip, chip->max_voltage_mv - chip->resume_delta_mv);//sjc1125//qpnp_chg_vbatdet_set(chip, chip->cool_bat_mv
		//		- chip->resume_delta_mv);
...
#define BATT_RECHARGING_VOLTAGE__COOL 			4200 * 1000//sjc1125//4100 * 1000
